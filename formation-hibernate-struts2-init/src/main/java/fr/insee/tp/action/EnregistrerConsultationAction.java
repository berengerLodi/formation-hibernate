...
public class EnregistrerConsultationAction extends ActionSupport implements Preparable {
	...
	private static final Logger logger = Logger.getLogger(EnregistrerConsultationAction.class);
